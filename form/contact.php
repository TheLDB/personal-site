<?php
    ...
    {
        $name = $_POST['InputName']; // Get Name value from HTML Form
        $email_id = $_POST['InputEmail']; // Get Email Value
        $subject = $_POST['InputSubject']; // Get Mobile No
        $msg = $_POST['InputMessage']; // Get Message Value
         
        $to = "ldb@erikboles.com"; // You can change here your Email
